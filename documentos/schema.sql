...
-- =========================================================
-- BLOCO 02 - REMOÇÃO DAS TABELAS (ORDEM SEGURA)
-- =========================================================
...
-- Finalidade:
-- Guarda tokens temporários para redefinição de senha.
-- =========================================================
...
-- Finalidade:
-- Cadastro das fontes externas de onde os editais serão coletados.
-- =========================================================
...
-- Finalidade:
-- Registra cada execução de coleta e seus resultados.
-- =========================================================
...
-- Finalidade:
-- Armazena os editais já normalizados no padrão interno do sistema.
-- =========================================================
...
-- Finalidade:
-- Termos utilizados para o motor de correspondência.
-- =========================================================
...
-- Finalidade:
-- Permite que a empresa acompanhe editais estratégicos.
-- =========================================================
...
-- Finalidade:
-- Histórico de arquivos CSV/PDF exportados.
-- =========================================================
...
-- Finalidade:
-- Rastreia ações críticas do sistema e de usuários.
-- =========================================================
...
-- Finalidade:
-- Cria planos e fontes básicas do sistema.
-- =========================================================
INSERT INTO planos (
...
-- =========================================================
-- BLOCO 21 - OBSERVAÇÃO FINAL
-- Para criar o usuário SUPER_ADMIN inicial:
-- 1. gere o hash da senha no PHP com password_hash()
-- 2. faça o INSERT manual na tabela usuarios
-- =========================================================
