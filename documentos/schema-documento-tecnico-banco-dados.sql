...
1) JSON foi utilizado em algumas tabelas para flexibilidade.

2) O campo hash_unico é essencial para evitar duplicidades.

3) O controle de correspondências deve ser feito também
   no backend para evitar duplicações por NULL.

4) Índices foram definidos para acelerar consultas
